...
# FIXME: this should always run on the localhost
...
#add(username='test1', cn="Then, Hans", sn="Then", givenName="Hans", shell='/bin/bash', password='system')
#add(username='test1', cn="Then, Hans", sn="Then", givenName="Hans", shell='/bin/bash', password='system')
#delete(username='hansthen8')
list()
